...
return new class extends SettingsMigration {
    public function up(): void
    {
        ...
        */
        ...
        $settings = [
            // General Info
            ['name' => 'name', 'payload' => 'Panelco I'],
            ['name' => 'description', 'payload' => 'Pangasinan I Electric Cooperative (Panelco I) is the exclusive franchise holder to operate an electric light and power services in the City of Alaminos and Municipalities of Agno, Anda, Bani, Bolinao, Burgos, Dasol, Infanta, and Mabini - all in the province of Pangasinan.'],
            ['name' => 'icon', 'payload' => '/app-settings/app-icon.png'],
            ['name' => 'logo', 'payload' => '/app-settings/app-logo.png'],
            ['name' => 'website', 'payload' => 'https://panelcoi.com/'],
